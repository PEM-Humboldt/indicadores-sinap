...
Para mayor información tecnica revisar el [documento extenso del indicador: Porcentaje y cambio de la representatividad de la riqueza de especies del SINAP](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/anexos/vineta_tecnica_cambio_riqueza_spp.md) Mientras que el [codigo operativo](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R/1_1_rep_ri_cod_operativo.R) le dara las instrucciones y la documentacion para ejecutar el indicador. El [codigo de representaciones](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R/1_2_rep_ri_cod_representaciones.R) le ayudara a generar los mapas, graficas y tablas asociadas.

Para el año 2024 se desarrollo una rutina nueva que hace mas eficiente el proceso de calculo, esta puede ser encontrada [aqui](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R-2024/rep_ri_cod_operativo-2024.R).
...
Para mayor información tecnica revisar el [documento extenso del indicador: Cambio en el porcentaje de representatividad ecológica del SINAP - Distribución de Especies](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/anexos/vineta_tecnica_representatividad_distribucion_spp.md) Mientras que el [codigo operativo](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R/2_1_rep_distspp_operativo.R) le dara las instrucciones y la documentacion para ejecutar el indicador. El [codigo de representaciones](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R/2_2_rep_distspp_representaciones.R) le ayudara a generar los mapas, graficas y tablas asociadas.

Para el año 2024 se desarrollo una rutina nueva que hace mas eficiente el proceso de calculo, esta puede ser encontrada [aqui](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R-2024/rep_distspp_operativo-2024.R).
...
Para mayor información tecnica revisar el [documento extenso del indicador: Cambio en la media de la representatividad de integridad estructural del SINAP](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/anexos/vineta_tecnica_representatividad_funcional.md) Mientras que el [codigo operativo](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R/3_1_rep_func_operativo.R) le dara las instrucciones y la documentacion para ejecutar el indicador. El [codigo de representaciones](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R/3_2_rep_func_representaciones.R) le ayudara a generar los mapas, graficas y tablas asociadas. Para este indicador se realizo un [análisis de sensibilidad](https://github.com/PEM-Humboldt/indicadores-sinap/tree/master/anexos/analisis_sensibilidad_representatividad_funcional) al cambio del tamaño de buffer usado para calcular la influencia de un Area Protegida.
...
Para mayor información tecnica revisar el [documento extenso del indicador: Cambio en el porcentaje de área protegida y conectada del SINAP](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/anexos/vineta_tecnica_bien_conectado.md) Mientras que el [codigo operativo](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R/4_1_bien_conectado_cod_operativo.R) le dara las instrucciones y la documentacion para ejecutar el indicador. El [codigo de representaciones](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/R/4_2_bien_conectado_cod_representaciones.R) le ayudara a generar los mapas, graficas y tablas asociadas. Para este indicador se realizo una explicación del flujo para generar los insumos de [areas protegidas](https://github.com/PEM-Humboldt/indicadores-sinap/blob/master/anexos/vineta_tecnica_bien_conectado_insumos.md) que amalgaman unidades transfronterizas y las areas protegidas de Colombia.
