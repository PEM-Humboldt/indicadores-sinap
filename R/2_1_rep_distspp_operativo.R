...
#      rep_distSpp_2000, rep_distSpp_2010, rep_distSpp_2020, rep_distSpp_Terr_1990, rep_distSpp_Terr_2000,
#      rep_distSpp_Terr_2010, rep_distSpp_Terr_2020, rep_distSpp_Terr_res, RUNAP_1990, RUNAP_2000, 
#      RUNAP_2010, RUNAP_2020, sp_stats_1990, sp_stats_2000, sp_stats_2010, sp_stats_2020, 
#      Territoriales, Delta_rep_distSpp_Nal, list_raster, rep_distSpp_Nal, 
#      rep_distSpp_Nal, rep_distSpp_terri, tiempos, DistSpRUNAP, lm.func, 
#      file = "rep_distspp_cod/rep_distspp_objetos_operativo.RData")
